...
import 'package:flutter_list_order/reorder/widgets/reorderable_list.dart' as custom;
...
class ReorderableListView extends StatefulWidget {
  ...
  final custom.ReorderItemProxyDecorator? proxyDecorator;
    ...
    if (widget.buildDefaultDragHandles) {
      switch (Theme.of(context).platform) {
                ...
                children: <Widget>[
                  ...
                  Positioned.directional(
                    ...
                    child: Align(
                      ...
                      child: custom.ReorderableDragStartListener(
                        index: index,
        ...
        case TargetPlatform.fuchsia:
          return custom.ReorderableDelayedDragStartListener(
            key: itemGlobalKey,
            index: index,
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScrollView(
      ...
      slivers: <Widget>[
        ...
        SliverPadding(
          padding: listPadding,
          sliver: custom.SliverReorderableList(
